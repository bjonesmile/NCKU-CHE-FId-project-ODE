...
Fin1(m)$(ord(m) lt 40)..Fin(m)=e=Fin(m+1);
Fin2(m)$((ord(m) gt 40) and (ord(m) lt 80))..Fin(m)=e=Fin(m+1);
Fin3(m)$((ord(m) gt 80) and (ord(m) lt 120))..Fin(m)=e=Fin(m+1);
Fin4(m)$((ord(m) gt 120) and (ord(m) lt 160))..Fin(m)=e=Fin(m+1);
Fin5(m)$((ord(m) gt 160) and (ord(m) lt 200))..Fin(m)=e=Fin(m+1);
Fin6(m)$((ord(m) gt 200) and (ord(m) lt 240))..Fin(m)=e=Fin(m+1);
Fout1(m)$(ord(m) lt 40)..Fout(m)=e=Fout(m+1);
Fout2(m)$((ord(m) gt 40) and (ord(m) lt 80))..Fout(m)=e=Fout(m+1);
Fout3(m)$((ord(m) gt 80) and (ord(m) lt 120))..Fout(m)=e=Fout(m+1);
Fout4(m)$((ord(m) gt 120) and (ord(m) lt 160))..Fout(m)=e=Fout(m+1);
Fout5(m)$((ord(m) gt 160) and (ord(m) lt 200))..Fout(m)=e=Fout(m+1);
Fout6(m)$((ord(m) gt 200) and (ord(m) lt 240))..Fout(m)=e=Fout(m+1);
