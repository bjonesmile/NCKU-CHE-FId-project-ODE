...
Fin1(m)$(ord(m) lt 80)..Fin(m)=e=Fin(m+1);
Fin2(m)$((ord(m) gt 80) and (ord(m) lt 160))..Fin(m)=e=Fin(m+1);
Fin3(m)$((ord(m) gt 160) and (ord(m) lt 240))..Fin(m)=e=Fin(m+1);
Fout1(m)$(ord(m) lt 80)..Fout(m)=e=Fout(m+1);
Fout2(m)$((ord(m) gt 80) and (ord(m) lt 160))..Fout(m)=e=Fout(m+1);
Fout3(m)$((ord(m) gt 160) and (ord(m) lt 240))..Fout(m)=e=Fout(m+1);
