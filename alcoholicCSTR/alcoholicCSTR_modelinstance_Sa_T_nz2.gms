...
Fin1(m)$(ord(m) lt 120)..Fin(m)=e=Fin(m+1);
Fin2(m)$((ord(m) gt 120) and (ord(m) lt 240))..Fin(m)=e=Fin(m+1);
Fout1(m)$(ord(m) lt 120)..Fout(m)=e=Fout(m+1);
Fout2(m)$((ord(m) gt 120) and (ord(m) lt 240))..Fout(m)=e=Fout(m+1);
