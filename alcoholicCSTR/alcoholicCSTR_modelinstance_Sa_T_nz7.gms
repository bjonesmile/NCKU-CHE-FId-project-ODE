...
Fin1(m)$(ord(m) lt 34).. Fin(m) =e= Fin(m+1);
Fin2(m)$((ord(m) gt 34) and (ord(m) lt 68))..                Fin(m) =e= Fin(m+1);
Fin3(m)$((ord(m) gt 68) and (ord(m) lt 102))..                Fin(m) =e= Fin(m+1);
Fin4(m)$((ord(m) gt 102) and (ord(m) lt 137))..                Fin(m) =e= Fin(m+1);
Fin5(m)$((ord(m) gt 137) and (ord(m) lt 171))..                Fin(m) =e= Fin(m+1);
Fin6(m)$((ord(m) gt 171) and (ord(m) lt 205))..                Fin(m) =e= Fin(m+1);
Fin7(m)$((ord(m) gt 205) and (ord(m) lt 240))..                Fin(m) =e= Fin(m+1);
Fout1(m)$(ord(m) lt 34).. Fout(m) =e= Fout(m+1);
Fout2(m)$((ord(m) gt 34) and (ord(m) lt 68))..                Fout(m) =e= Fout(m+1);
Fout3(m)$((ord(m) gt 68) and (ord(m) lt 102))..                Fout(m) =e= Fout(m+1);
Fout4(m)$((ord(m) gt 102) and (ord(m) lt 137))..                Fout(m) =e= Fout(m+1);
Fout5(m)$((ord(m) gt 137) and (ord(m) lt 171))..                Fout(m) =e= Fout(m+1);
Fout6(m)$((ord(m) gt 171) and (ord(m) lt 205))..                Fout(m) =e= Fout(m+1);
Fout7(m)$((ord(m) gt 205) and (ord(m) lt 240))..                Fout(m) =e= Fout(m+1);
