        ...
        qout1(m)$(ord(m) lt 133).. qout(m) =e= qout(m+1);
        qout2(m)$((ord(m) gt 133) and (ord(m) lt 266))..                qout(m) =e= qout(m+1);
        qout3(m)$((ord(m) gt 266) and (ord(m) lt 400))..                qout(m) =e= qout(m+1);
        qout4(m)$((ord(m) gt 400) and (ord(m) lt 533))..                qout(m) =e= qout(m+1);
        qout5(m)$((ord(m) gt 533) and (ord(m) lt 666))..                qout(m) =e= qout(m+1);
        qout6(m)$((ord(m) gt 666) and (ord(m) lt 800))..                qout(m) =e= qout(m+1);
        h.fx('1') = h0;
