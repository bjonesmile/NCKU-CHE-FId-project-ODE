        ...
        qout1(m)$(ord(m) lt 100).. qout(m) =e= qout(m+1);
        qout2(m)$((ord(m) gt 100) and (ord(m) lt 200))..                qout(m) =e= qout(m+1);
        qout3(m)$((ord(m) gt 200) and (ord(m) lt 300))..                qout(m) =e= qout(m+1);
        qout4(m)$((ord(m) gt 300) and (ord(m) lt 400))..                qout(m) =e= qout(m+1);
        qout5(m)$((ord(m) gt 400) and (ord(m) lt 500))..                qout(m) =e= qout(m+1);
        qout6(m)$((ord(m) gt 500) and (ord(m) lt 600))..                qout(m) =e= qout(m+1);
        qout7(m)$((ord(m) gt 600) and (ord(m) lt 700))..                qout(m) =e= qout(m+1);
        qout8(m)$((ord(m) gt 700) and (ord(m) lt 800))..                qout(m) =e= qout(m+1);
        h.fx('1') = h0;
